...
public:
	MultipleDeviceParameter(std::string name, std::string fullname, std::vector<T> values) : DeviceParameter(name, fullname, DeviceParameterType::Multiple), values(values) {};
